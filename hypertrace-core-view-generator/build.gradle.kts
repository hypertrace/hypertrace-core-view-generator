...
dependencies {
  ...
  implementation("org.hypertrace.core.viewgenerator:view-generator-framework:0.4.2")
  implementation("org.hypertrace.core.datamodel:data-model:0.1.22")
  implementation("org.hypertrace.core.spannormalizer:raw-span-constants:0.7.6")
